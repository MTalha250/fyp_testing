...
const EditService = () => {
    ...
    >
      <HeaderDashboard/>
        <div className="flex flex-col w-full gap-4 items-start justify-start">
          <h2 className="text-4xl pb-10 w-full text-center font-bold mt-5">Edit Service</h2>
            ...
            <div className="w-full md:flex-1 flex items-start justify-start flex-col gap-2">
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <input
                  ...
                  id="shortTitle"
                  onChange={handleChange}
                  defaultValue={gigData?.shortTitle}
                  // onBlur={handleBlur}
              ...
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <textarea
                  ...
                  id="shortDesc"
                  onChange={handleChange}
                  defaultValue={gigData?.shortDesc}
                  // onBlur={handleBlur}
              ...
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <input
                  type="text"
                  name="deliveryTime"
                  defaultValue={gigData?.deliveryTime}
                  onChange={handleChange}
                  // onBlur={handleBlur}
              ...
              <div className="flex flex-col w-full gap-1 items-start justify-start">
                ...
                <input
                  ...
                  name="revisionNumber"
                  onChange={handleChange}
                  defaultValue={gigData?.revisionNumber}
                  // onBlur={handleBlur}
  ...
  {[
    ...(gigData?.features?.map((f) => ({ source: 'gigData', feature: f })) || []),
    ...(state?.features?.map((f) => ({ source: 'state', feature: f })) || []),
  ].map(({ source, feature }) => (
    <div
    ...
    >
      <button
        onClick={() => {
          if (source === 'gigData') {
            // Dispatch an action or handle gigData feature removal
            dispatch({ type: "REMOVE_FEATURE_FROM_GIGDATA", payload: feature });
          } else {
            // Handle state feature removal
