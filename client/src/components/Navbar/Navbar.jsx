...
console.log("auth", authUser);
  ...
  return (
    <header
      className={`flex items-center justify-center w-full flex-col text-white  transition-all ease-in-out z-20 ${
    ...
    >
      <div className="contain">
        <div className="w-full flex items-center justify-between py-4 relative">
          ...
          />
          <div className="flex bg-[white] items-center gap-2 h-full justify-between w-[50%] sm:w-fit">
            <span onClick={() => setShowLink(true)} className="lg:hidden mt-1">
              <FaBars size={25} />
            </span>
            <Link
              to="/"
              className="text-[#000000] text-4xl select-none font-black tracking-tighter"
            >
              <span>ServiceLance</span>
              {/* <span className="text-primary">.</span> */}
            </Link>
          </div>
          <nav className="text-[#000000] flex items-center justify-end gap-7 font-medium text-base">
            ...
            {authUser ? (
              <>
                {authUser && (
                  ...
                  //   </div>
                  // </div>
                  <NavLink to="/dashboard" className="cursor-pointer hidden lg:flex">
                    Dashboard
                  </NavLink>
                )}
              </>
